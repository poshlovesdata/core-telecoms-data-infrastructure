...
- [001 - Infrastructure Setup](https://poshlovesdata.github.io/core-telecoms-data-infrastructure/architecture_decisions/001_infrastructure_setup/): Cloud foundation, networking, and security.

- [002 - Compute & Security](https://poshlovesdata.github.io/core-telecoms-data-infrastructure/architecture_decisions/002_compute_and_security/): Snowflake vs. Redshift and Identity Management.

- [003 - Orchestration](https://poshlovesdata.github.io/core-telecoms-data-infrastructure/architecture_decisions/003_orchestration_setup/): Airflow 3.0 configuration and event-driven scheduling.

- [004 - Static Ingestion](https://poshlovesdata.github.io/core-telecoms-data-infrastructure/architecture_decisions/004_static_data_ingestion/): Handling Google Sheets and messy CSVs.

- [005 - Dynamic Ingestion](https://poshlovesdata.github.io/core-telecoms-data-infrastructure/architecture_decisions/005_dynamic_ingestion/): Incremental extraction patterns for DBs and Logs.

- [006 - Data Loading](https://poshlovesdata.github.io/core-telecoms-data-infrastructure/architecture_decisions/006_data_loading_snowflake/): Secure Snowflake-S3 integration.

- [007 - Transformation](https://poshlovesdata.github.io/core-telecoms-data-infrastructure/architecture_decisions/007_transformation_dbt/): dbt Medallion architecture and data modeling.

- [008 - CI/CD & Automation](https://poshlovesdata.github.io/core-telecoms-data-infrastructure/architecture_decisions/008_cicd_automation/): DevOps pipelines and quality gates.

## Architecture

![Core Telecoms Architecture](docs/images/core-telecoms-dark.drawio.png)
